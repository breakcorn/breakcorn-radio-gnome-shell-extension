...
![GNOME Shell](https://img.shields.io/badge/GNOME%20Shell-45%20%7C%2046%20%7C%2047%20%7C%2048-4A90E2)
...
- **Ubuntu**: 22.04 LTS, 24.04 LTS, or 25.04 (recommended)
...
The installer will:
- ✅ Check system compatibility (Ubuntu LTS/25.04, GNOME Shell 45-48)
- ✅ Verify and install GStreamer dependencies
- ✅ Test audio pipeline functionality
- ✅ Install and enable the extension automatically
...
- ✅ **Fixed**: UUID error in uninstall process
- ✅ **Added**: Simplified installation script (simple-install.sh)
- ✅ **Improved**: Installation process reliability

### Version 0.0.7
- ✅ **Enhanced**: Installation script improvements
