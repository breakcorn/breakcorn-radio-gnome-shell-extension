...
const DIR_NAME = ".breakcorn-radio";
...
export function load() {
  ...
  try {
    ...
    console.error("Breakcorn-Radio: failed to load json: " + e);
    return defaultData;
  }
  // parse json file
  try {
    ...
    console.error("Breakcorn-Radio: Failed to parse json: " + e);
    return defaultData;
  }
  return channelList;
}
...
export function create(dir_path) {
  ...
  if (!dir.query_exists(null)) {
    try {
      ...
      console.error("Breakcorn-Radio: Failed to create directory and/or file! " + e);
    }
  } else {
    let file = dir.get_child(FILE_NAME);
    if (!file.query_exists(null)) {
      try {
        ...
        console.error("Breakcorn-Radio: Failed to create file! " + e);
      }
    }
  }
}
